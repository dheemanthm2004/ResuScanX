  ...
  🤖 Free ATS Checker
        ...
        >
          <div className="bg-gradient-to-br from-violet-50/80 to-purple-50/80 backdrop-blur-sm rounded-3xl p-12 border border-violet-200/30 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { num: '4', title: 'AI Providers', desc: 'Gemini, Mistral, Cohere & OpenRouter for reliability', gradient: 'from-violet-500 to-purple-600' },
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              { text: '✨ Gemini AI', colors: 'from-orange-100 to-orange-200 text-orange-700' },
              { text: '🧠 Mistral AI', colors: 'from-purple-100 to-purple-200 text-purple-700' },
              { text: '💎 Cohere AI', colors: 'from-emerald-100 to-emerald-200 text-emerald-700' },
              { text: '🤖 OpenRouter', colors: 'from-blue-100 to-blue-200 text-blue-700' },
